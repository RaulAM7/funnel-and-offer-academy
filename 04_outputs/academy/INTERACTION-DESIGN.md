...
4. Procesa el material y produce dos archivos:
   - `03_blocks/block-NN_descriptor.md` — resumen corto del bloque (30-50 lineas)
...
5. Actualiza `STATE.md` — bloque marcado como completado, log de sesion actualizado, siguiente paso propuesto
