# Next Actions — IA Mujeres

## Owner siguiente

CRM/GWS, previsiblemente en el repo `skilland-crm`.
...
- Rebotes relevantes.
- Error de personalizacion.
- Firma ausente o incorrecta.
- Adjunto incorrecto.
- Respuestas negativas que indiquen problema de tono.
- Mala entregabilidad.
- Dudas sobre destinatario, entidad o area.

## No hacer desde Funnel Academy
