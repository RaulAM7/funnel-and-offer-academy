...
- **Rich source block** (dense theory, many concepts): detailed extraction with subsections per concept
...
- Both using consistent naming: `block-NN_descriptor.md` / `extraction-block-NN.md`
